...
export default function SolutionSubmission({
  ...
  const handleSubmit = async () => {
    if (!uploadedImageUrl || !onSubmit || !user) return;
        ...
        <CardContent className="flex-1 flex flex-col space-y-4 sm:space-y-6">
          {!user ? (
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-md p-3 text-sm text-blue-800">
                ...
                <p className="text-blue-700 text-xs sm:text-sm">
                  Please log in or create an account to submit your solution.
                  This helps us track your progress and save your work.
                </p>
              </div>
            ...
            <>
              ...
              {/* Submit Button - Only show when image is uploaded */}
              {hasUploadedImage && (
                <Button
                  className="h-10 sm:h-12 text-sm sm:text-lg"
